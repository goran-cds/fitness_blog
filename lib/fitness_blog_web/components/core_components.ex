defmodule FitnessBlogWeb.CoreComponents do
  @moduledoc """
  ...
  attr :can_exit, :boolean, default: true
    ...
    >
      ...
      >
        <div class="flex min-h-full items-center justify-center">
          <div class={["p-4 sm:p-6 lg:py-8", @width]}>
            <.focus_wrap
              id={"#{@id}-container"}
            ...
            >
              <div :if={@can_exit} class="absolute top-6 right-5">
                <button
                  phx-click={if @can_exit, do: JS.exec("data-cancel", to: "##{@id}")}
                  type="button"
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "resize-none mt-1 block w-full rounded-lg text-hs_main_900 focus:ring-0 sm:text-sm sm:leading-6",
  ...
  def label(assigns) do
    ~H"""
    <label for={@for} class="block text-sm font-semibold leading-6 text-hs_neutral_600">
      <%= render_slot(@inner_block) %>
    </label>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FitnessBlogWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FitnessBlogWeb.Gettext, "errors", msg, opts)
    end
  end
